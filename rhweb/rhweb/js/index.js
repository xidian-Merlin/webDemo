...
$(document).ready(function (){
	...
	// 插件全局初始化
	require(['/js/plugin/tablegrid/tablegrid.js',
			'/js/plugin/grid/grid.js',
			 ...
			 '/js/lib/charts/skycons/skycons.js'] ,function (tablegrid ,grid ,mask ,dialog ,menu ,validate ,moment ,monitor ,formel ,topo ,skyCons){
		...
		menu.render($("#menu") ,{
			//url : "data/menu.json"
			url : "sysconfig/menuconfig/queryUserMenuTree"
		});
