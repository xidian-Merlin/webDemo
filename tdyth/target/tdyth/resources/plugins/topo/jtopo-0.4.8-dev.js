!
                    ...
                    return scenes.forEach(function(a) {
                            ...
                            d.forEach(function(a) {
                                    ...
                                    for (var e in a) {
                                        //加载节点的图片
                                        if (e == "nodeImage") {
                                            c.setImage(context + 'img/topo/' + a[e]);
                                        }
                                        if (c) {
                                            if (a[e] == "undefined") {
                                                c[e] = undefined;
    ...
    function(JTopo) {
        ...
        function genImageAlarm(a, b) {
            // null  == b && (b = 255);
            // var _r = null,_g = null,_b = null;
            // if(null == b){
            //     _r = 255;
            // }else {
            //     var alarmColors = b.split(",");
            //     _r = parseInt(alarmColors[0]);
            //     _g = parseInt(alarmColors[1]);
            //     _b = parseInt(alarmColors[2]);
            // }
            // try {
            //     if (alarmImageCache[a.src])
            //         return alarmImageCache[a.src];
            //     var c = new Image;
            //     return c.src = changeColor(graphics, a, _r,_g,_b),
            ...
            this.initialize = function(c) {
                ...
                this.paintAlarmIcon = function(a){//myTopoStyle新加方法
                    function drawFault(w,h,alpha){
                        ...
                        faultImage.src =  "/img/topo/new/alarm/faultEvent.svg";
                        var b = a.globalAlpha;
                        a.globalAlpha = alpha,
                        a.drawImage(faultImage, faultWidth / 2, faultHeight / 2, faultWidth, faultHeight),
                        a.globalAlpha = b
                    }
                    function drawPerfrom(w,h,alpha){
                        ...
                        var faultWidth = w * 0.3 ;
                        var faultImage = new Image;
                        faultImage.src = "/img/topo/new/alarm/performanceEvent.svg";
                        var b = a.globalAlpha;
                        a.globalAlpha = alpha,
                        a.drawImage(faultImage, -faultWidth / 2*3, faultHeight / 2, faultWidth, faultHeight),
                        a.globalAlpha = b
                    }
                    function drawHealthlevel(w,h,alpha,src){
                        ...
                        var b = a.globalAlpha;
                        a.globalAlpha = alpha,
                        a.drawImage(faultImage, faultWidth / 2, -faultHeight / 2*3, faultWidth, faultHeight),
                        a.globalAlpha = b
                    }
                    if(this.myTopoStyle&&this.eventlevel){
                        ...
                        if(this.healthlevel=='2'){//正常
                            drawHealthlevel(this.width,this.height,this.alpha,'/img/topo/new/health/normal.svg');
                        }else if(this.healthlevel=='1'){//性能
                            drawHealthlevel(this.width,this.height,this.alpha,'/img/topo/new/health/perf.svg');
                        }else if(this.healthlevel=='0'){//故障
                            drawHealthlevel(this.width,this.height,this.alpha,'/img/topo/new/health/fault.svg');
                        }else if(this.healthlevel=='-1'){//未知
                            drawHealthlevel(this.width,this.height,this.alpha,'/img/topo/new/health/unknown.svg');
                        }
                    }else if(this.myTopoStyle&&this.configstatus){
                        if(this.configstatus=='0'){
                            drawHealthlevel(this.width,this.height,this.alpha,'/img/topo/new/health/unconfig.svg');
                        }else {
                            drawHealthlevel(this.width,this.height,this.alpha,'/img/topo/new/health/config.svg');
                        }
                    }
                }
                ,
                    ...
                    if ("string" == typeof b) {
                        ...
                        null  == e ? (e = new Image,
                                ...
                                e.onload = function() {
                                    ...
                                    var f = a.util.genImageAlarm(e,this.alarmColor);
                                    f && (e.alarm = f),
                                        d.image = e
                                }
                ...
                if (4 == b.length && (c = b[1],
                    ...
                    if (this.nodeA === this.nodeZ) {
                        ...
                        if(b.length==4){
                            ...
                            delts = a.measureText(this.textS).width/2 + deltS;
                            a.restore();
                            ...
                            delte = a.measureText(this.textE).width/2 + deltE;
                            a.restore();
