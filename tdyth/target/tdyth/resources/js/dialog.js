...
define(['/tdyth/resources/plugins/mask/mask.js' ,'/tdyth/resources/lib/bootstrap-sweetAlert/sweetalert-dev.js'] ,function (mask ,sweetAlert){
	...
	buffer.push('<button data-id="close" class="btn btn-default dialog-remove" type="button" style="padding-left:30px">关闭</button>');
	buffer.push('<button data-id="save" class="btn btn-primary dialog-ok" type="button" style="padding-left:30px">确认</button>');
