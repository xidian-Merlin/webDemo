...
function edit_template_init(rowData)
{
	...
	var url = rowData? "/tdyth/resources/js/eqpManager/eqpSecDom_tpl.html" : "/tdyth/resources/js/eqpManager/eqpSecDom_tpl_1.html"
	$.ajax({
		type: "GET",
		url: url,
		success : function(data){
...
function detail_template_init(rowData)
{
	...
	/*$.ajax({
		type: "GET",
		url: "/tdyth/resources/js/eqpManager/eqpSecDom_tpl.html",
		success :function(data)
		{
