...
!function ($) {
	...
	Datetimepicker.prototype = {
		...
		setValue: function () {
			...
			{
				$(this.element[0]).removeClass("form-invalid");
				$(this.element[0]).parent().find("[class*=err-div]").remove();
				$(this.element[0]).parent().find("[class*=form-invalid]").removeClass("form-invalid");
			}
		},
