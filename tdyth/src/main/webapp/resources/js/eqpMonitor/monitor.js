...
require(['/tdyth/resources/plugins/accordion/accordion.js',
		 'tree',
		 '/tdyth/resources/plugins/wizard/wizard.js',
		 '/tdyth/resources/plugins/monitor/monitor.js',
		 '/tdyth/resources/plugins/monitor/monitor_config_tool.js',
		 '/tdyth/resources/plugins/timepicker/timepicker.js',
		 '/tdyth/resources/plugins/inputdrop/inputdrop.js'] ,function (accordion ,tree ,wizard ,monitor ,monitorTool ,timepicker ,inputdrop){
...
function event_init()
{
	...
	$("#accordion_icon").find("div").click(function (){
		...
		$.ajax({
			type:GET,
			url: "/tdyth/resources/js/monitortree.json",
