...
(function (t, n) {
	...
	function l(t, n) {
		function e(e) {
			...
			e !== w && (M = M.transition(e), T = T.transition(e), S = S.transition(e), E = E.transition(e), N = N.transition(e).attr("opacity", Ys).attr("transform", function (t) {
	...
	function C(t, n, e, r, i, o) {
		for (var u, a = 0, c = n.length, s = o.length; a < s; ++a)
			(u = n[a]) ? (u.__data__ = o[a], r[a] = u) : e[a] = new A(t, o[a]);
		for (; a < c; ++a)
			(u = n[a]) && (i[a] = u)
	}
	function z(t, n, e, r, i, o, u) {
		...
		p = new Array(l);
		for (a = 0; a < l; ++a)
			(c = n[a]) && (p[a] = s = af + u.call(c, c.__data__, a, n), s in f ? i[a] = c : f[s] = c);
		for (a = 0; a < h; ++a)
			(c = f[s = af + u.call(t, o[a], a, o)]) ? (r[a] = c, c.__data__ = o[a], f[s] = null) : e[a] = new A(t, o[a]);
		for (a = 0; a < l; ++a)
			(c = n[a]) && f[p[a]] === c && (i[a] = c)
	}
	function P(t, n) {
	...
	function Tt(t) {
		...
		(n = mf.exec(t)) ? (n = parseInt(n[1], 16), new At(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, (15 & n) << 4 | 15 & n, 1)) : (n = xf.exec(t)) ? Nt(parseInt(n[1], 16)) : (n = bf.exec(t)) ? new At(n[1], n[2], n[3], 1) : (n = wf.exec(t)) ? new At(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, 1) : (n = Mf.exec(t)) ? kt(n[1], n[2], n[3], n[4]) : (n = Tf.exec(t)) ? kt(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4]) : (n = Nf.exec(t)) ? Ct(n[1], n[2] / 100, n[3] / 100, 1) : (n = kf.exec(t)) ? Ct(n[1], n[2] / 100, n[3] / 100, n[4]) : Sf.hasOwnProperty(t) ? Nt(Sf[t]) : "transparent" === t ? new At(NaN, NaN, NaN, 0) : null
	}
	function Nt(t) {
	...
	function St(t) {
		...
		t ? (t = t.rgb(), new At(t.r, t.g, t.b, t.opacity)) : new At
	}
	function Et(t, n, e, r) {
	...
	function tn(t) {
		return function (n) {
			...
			a = new Array(i);
			for (e = 0; e < i; ++e)
				r = Et(n[e]), o[e] = r.r || 0, u[e] = r.g || 0, a[e] = r.b || 0;
			return o = t(o),
			u = t(u),
			a = t(a),
			r.opacity = 1,
	...
	function vn() {
		...
		++Nl;
		for (var t, n = Zf; n; )
			(t = Cl - n._time) >= 0 && n._call.call(null, t), n = n._next;
		--Nl
	}
	function _n() {
		Cl = (Al = Pl.now()) + zl,
	...
	function yn() {
		for (var t, n, e = Zf, r = 1 / 0; e; )
			e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : Zf = n);
		Gf = t,
		mn(r)
	}
	function mn(t) {
	...
	function Mn(t, n, e) {
		function r(c) {
			...
			if (Ll(function () {
				...
				for (e.state = Il, u = new Array(l = e.tween.length), s = 0, f = -1; s < l; ++s)
					(h = e.tween[s].value.call(t, t.__data__, e.index, e.group)) && (u[++f] = h);
				u.length = f + 1
			}
		}
		function i(n) {
			for (var r = n < e.duration ? e.ease.call(null, n / e.duration) : (e.timer.restart(o), e.state = Bl, 1), i = -1, a = u.length; ++i < a; )
				u[i].call(null, r);
	...
	function $n(t, n, e) {
		...
		return function () {
			var u = B(this, t),
			a = e(this);
			return null == a && (this.style.removeProperty(t), a = B(this, t)),
	...
	function he(n) {
		...
		function u() {
			...
			function o() {
				...
				case Th:
				case Mh:
					N && (g = Math.max(C - a, Math.min(P - p, g)), s = a + g, d = p + g),
					k && (y = Math.max(z - l, Math.min(R - v, y)), h = l + y, _ = v + y);
					break;
				case Nh:
					N < 0 ? (g = Math.max(C - a, Math.min(P - a, g)), s = a + g, d = p) : N > 0 && (g = Math.max(C - p, Math.min(P - p, g)), s = a, d = p + g),
					k < 0 ? (y = Math.max(z - l, Math.min(R - l, y)), h = l + y, _ = v) : k > 0 && (y = Math.max(z - v, Math.min(R - v, y)), h = l, _ = v + y);
					break;
				case kh:
					N && (s = Math.max(C, Math.min(P, a - g * N)), d = Math.max(C, Math.min(P, p + g * N))),
					k && (h = Math.max(z, Math.min(R, l - y * k)), _ = Math.max(z, Math.min(R, v + y * k)))
				}
				d < s && (N *= -1, t = a, a = p, p = t, t = s, s = d, d = t, M in zh && F.attr("cursor", Ch[M = zh[M]])),
				_ < h && (k *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, M in Ph && F.attr("cursor", Ch[M = Ph[M]])),
				S.selection && (A = S.selection),
				x && (s = A[0][0], d = A[1][0]),
				b && (h = A[0][1], _ = A[1][1]),
				A[0][0] === s && A[0][1] === h && A[1][0] === d && A[1][1] === _ || (S.selection = [[s, h], [d, _]], r.call(w), D.brush())
			}
			function u() {
				if (ue(), t.event.touches) {
					...
					_t(t.event.view, m), I.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);
				O.attr("pointer-events", "all"),
				F.attr("cursor", Ch.overlay),
				S.selection && (A = S.selection),
				le(A) && (S.selection = null, r.call(w)),
				D.end()
			}
			if (t.event.touches) {
			...
			if (f.apply(this, arguments)) {
				...
				"overlay" === M ? S.selection = A = [[a = n === Eh ? C : q[0], l = n === Sh ? z : q[1]], [p = n === Eh ? P : a, v = n === Sh ? R : l]] : (a = A[0][0], l = A[0][1], p = A[1][0], v = A[1][1]),
				s = a,
				h = l,
				d = p,
				_ = v;
		...
		e.extent = function (t) {
			return arguments.length ? (s = "function" == typeof t ? t : xh([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), e) : s
		},
		e.filter = function (t) {
	...
	function dr(t, n) {
		...
		if (jp) {
			...
			c = i[0] * dd * a,
			s = _d(u) > 180;
			s ^ (a * Ip < c && c < a * t) ? (o = i[1] * dd) > Fp && (Fp = o) : (c = (c + 360) % 360 - 180, s ^ (a * Ip < c && c < a * t) ? (o = -i[1] * dd) < Dp && (Dp = o) : (n < Dp && (Dp = n), n > Fp && (Fp = n))),
			s ? t < Ip ? xr(Up, t) > xr(Up, Op) && (Op = t) : xr(t, Op) > xr(Up, Op) && (Up = t) : Op >= Up ? (t < Up && (Up = t), t > Op && (Op = t)) : t > Ip ? xr(Up, t) > xr(Up, Op) && (Op = t) : xr(t, Op) > xr(Up, Op) && (Up = t)
		} else
			Hp.push(Xp = [Up = t, Op = t]);
		n < Dp && (Dp = n),
		n > Fp && (Fp = n),
	...
	function Or(t, n, e, r, i, o) {
		if (e) {
			...
			for (var s, f = i; r > 0 ? f > o : f < o; f -= c)
				s = ur([u, -a * md(f), -a * Td(f)]), t.point(s[0], s[1])
		}
	}
	function Fr(t, n) {
		(n = ar(n))[0] -= t,
	...
	function Xr(t, n, e, r) {
		...
		return function (u) {
			...
			function s() {
				for (var n = 0, e = 0, i = h.length; e < i; ++e)
					for (var o, u, a = h[e], c = 1, s = a.length, f = a[0], l = f[0], p = f[1]; c < s; ++c)
						o = l, u = p, l = (f = a[c])[0], p = f[1], u <= r ? p > r && (l - o) * (r - u) > (p - u) * (t - o) && ++n : p <= r && (l - o) * (r - u) < (p - u) * (t - o) && --n;
				return n
			}
			function f(o, u) {
				var a = i(o, u);
				if (h && p.push([o, u]), x)
					d = o, v = u, _ = a, x = !1, a && (w.lineStart(), w.point(o, u));
				else if (a && m)
					w.point(o, u);
				else {
			...
			T = {
				...
				lineEnd: function () {
					l && (f(d, v), _ && m && M.rejoin(), l.push(M.result())),
					T.point = c,
					m && w.lineEnd()
				},
				...
				polygonEnd: function () {
					...
					n = b && t,
					e = (l = Ps(l)).length;
					(n || e) && (u.polygonStart(), n && (u.lineStart(), o(null, null, 1, u), u.lineEnd()), e && Kd(l, a, t, o, u), u.polygonEnd()),
					w = u,
					l = h = p = null
				}
			};
	...
	function Ci(t) {
		...
		n.clipExtent = function (t) {
			return arguments.length ? (S = null == t ? (k = l = h = p = null, _v) : Xr(k = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == k ? null : [[k, l], [h, p]]
		},
		n.scale = function (t) {
		...
		for (null == n && (n = oo); e = s.pop(); )
			if (c && (e.value = +e.data.value), (i = n(e.data)) && (u = i.length))
				for (e.children = new Array(u), o = u - 1; o >= 0; --o)
					s.push(r = e.children[o] = new co(i[o])), r.parent = e, r.depth = e.depth + 1;
	...
	function Mo(t) {
		...
		t: for (a = 3; a < i; ++a) {
			...
			for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = bo(n); (r = r.next) !== e; )
				(u = bo(r)) < o && (n = r, o = u);
			e = n.next
		}
		for (n = [e._], r = e; (r = r.next) !== e; )
			n.push(r._);
		for (r = Jv(n), a = 0; a < i; ++a)
		...
		for (var n, e, r, i, o, u = new Fo(t, 0), a = [u]; n = a.pop(); )
			if (r = n._.children)
				for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i)
					a.push(e = n.children[i] = new Fo(r[i], i)), e.parent = n;
		...
		function n(t, n) {
			return function (e) {
				...
				for (e instanceof Date || (e = new Date(+e)); ++a < s; )
					37 === t.charCodeAt(a) && (u.push(t.slice(c, a)), null != (i = Fg[r = t.charAt(++a)]) ? r = t.charAt(++a) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), u.push(r), c = a + 1);
		...
		function r(t, n, e, r) {
			for (var i, o, u = 0, a = n.length, c = e.length; u < a; ) {
				...
				if (37 === (i = n.charCodeAt(u++))) {
					if (i = n.charAt(u++), !(o = T[i in Fg ? n.charAt(u++) : i]) || (r = o(t, e, r)) < 0)
						return -1
	...
	function Wa(t) {
		function n() {
			...
			c = e.apply(this, a),
			s = r.apply(this, a);
			if (u || (u = n = ve()), t(u, +i.apply(this, (a[0] = c, a)), +o.apply(this, a), +i.apply(this, (a[0] = s, a)), +o.apply(this, a)), n)
		...
		for (i = 0; i < _; ++i)
			if (o = lm[i]) {
				...
				for (a = 0, s = c.length; a < s; )
					d = (p = Ic(o, pm[c[a]]))[0], v = p[1], l = (f = Fc(o, pm[c[++a % s]]))[0], h = f[1], (Math.abs(d - l) > _m || Math.abs(v - h) > _m) && (c.splice(a, 0, pm.push(Pc(u, p, Math.abs(d - t) < _m && r - v > _m ? [t, Math.abs(l - t) < _m ? h : r] : Math.abs(v - r) < _m && e - d > _m ? [Math.abs(h - r) < _m ? l : e, r] : Math.abs(d - e) < _m && v - n > _m ? [e, Math.abs(l - e) < _m ? h : n] : Math.abs(v - n) < _m && d - t > _m ? [Math.abs(h - n) < _m ? l : t, n] : null)) - 1), ++s);
				s && (g = !1)
			}
		if (g) {
			var y,
			...
			for (i = 0, g = null; i < _; ++i)
				(o = lm[i]) && (x = (y = (u = o.site)[0] - t) * y + (m = u[1] - n) * m) < b && (b = x, g = o);
			if (g) {
				var w = [t, n],
				M = [t, r],
				T = [e, r],
	...
	function Zc(t) {
		...
		for (var c = o; c.circle && Math.abs(e - c.circle.x) < _m && Math.abs(r - c.circle.cy) < _m; )
			o = c.P, a.unshift(c), Wc(c), c = o;
		a.unshift(c),
		Xc(c);
		for (var s = u; s.circle && Math.abs(e - s.circle.x) < _m && Math.abs(r - s.circle.cy) < _m; )
			u = s.N, a.push(s), Wc(s), s = u;
		a.push(s),
		Xc(s);
		var f,
		l = a.length;
		for (f = 1; f < l; ++f)
			s = a[f], c = a[f - 1], Rc(s.edge, c.site, s.site, i);
		c = a[0],
	...
	function Gc(t) {
		...
		if (fm.insert(n, c), n || e) {
			if (n === e)
				return Xc(n), e = Vc(n.site), fm.insert(c, e), c.edge = e.edge = zc(n.site, c.site), Hc(n), void Hc(e);
			if (e) {
				Xc(n),
				Xc(e);
				var s = n.site,
	...
	function ns(t, n) {
		...
		for (pm = [], lm = new Array(t.length), fm = new kc, hm = new kc; ; )
			if (i = sm, o && (!i || o[1] < i.y || o[1] === i.y && o[0] < i.x))
				o[0] === e && o[1] === r || (Gc(o), e = o[0], r = o[1]), o = t.pop();
			else {
				if (!i)
					break;
				Zc(i.arc)
	...
	As = function (t, n, e) {
		...
		if ((i = n < t) && (o = t, t = n, n = o), 0 === (a = r(t, n, e)) || !isFinite(a))
			return [];
		if (a > 0)
			for (t = Math.ceil(t / a), n = Math.floor(n / a), u = new Array(o = Math.ceil(n - t + 1)); ++c < o; )
				u[c] = (t + c) * a;
		else
			for (t = Math.floor(t * a), n = Math.ceil(n * a), u = new Array(o = Math.ceil(t - n + 1)); ++c < o; )
				u[c] = (t - c) / a;
		return i && u.reverse(),
		u
	},
	...
	pt.prototype = dt.prototype = {
		...
		on: function (t, n, e) {
			...
			u = o.length; {
				if (!(arguments.length < 2)) {
					for (a = n ? N : T, null == e && (e = !1), r = 0; r < u; ++r)
						this.each(a(o[r], n, e));
					return this
				}
	...
	sl = function (t, n) {
		...
		r,
		i,
		o = al.lastIndex = cl.lastIndex = 0,
		u = -1,
		a = [],
		c = [];
		for (t += "", n += ""; (e = al.exec(t)) && (r = cl.exec(n)); )
		...
		a.length < 2 ? c[0] ? en(c[0].x) : nn(n) : (n = c.length, function (t) {
			for (var e, r = 0; r < n; ++r)
				a[(e = c[r]).i] = e.x(t);
			return a.join("")
		})
	...
	yl = function (t, n) {
		...
		h = f * f + l * l;
		if (h < 1e-12)
			r = Math.log(s / u) / gl, e = function (t) {
	...
	pn.prototype = dn.prototype = {
		...
		restart: function (t, n, e) {
			...
			this._next || Gf === this || (Gf ? Gf._next = this : Zf = this, Gf = this),
			this._call = t,
			this._time = e,
			mn()
		},
	...
	Xl = function (t, n) {
		...
		if (o) {
			n = null == n ? null : n + "";
			for (i in o)
				(e = o[i]).name === n ? (r = e.state > Fl && e.state < Bl, e.state = jl, e.timer.stop(), r && e.on.call("interrupt", t, t.__data__, e.index, e.group), delete o[i]) : u = !1;
		...
		select: function (t) {
			...
			for (var r = this._groups, i = r.length, o = new Array(i), u = 0; u < i; ++u)
				for (var a, c, s = r[u], f = s.length, l = o[u] = new Array(f), h = 0; h < f; ++h)
					(a = s[h]) && (c = t.call(a, a.__data__, h, s)) && ("__data__" in a && (c.__data__ = a.__data__), l[h] = c, Hl(l[h], n, e, h, l, wn(a, e)));
	...
	de.prototype = ve.prototype = {
		...
		arc: function (t, n, e, r, i, o) {
			...
			e && (l < 0 && (l = l % Hh + Hh), l > Xh ? this._ += "A" + e + "," + e + ",0,1," + f + "," + (t - u) + "," + (n - a) + "A" + e + "," + e + ",0,1," + f + "," + (this._x1 = c) + "," + (this._y1 = s) : l > 1e-6 && (this._ += "A" + e + "," + e + ",0," +  + (l >= jh) + "," + f + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))))
		},
		...
		function n(t, n) {
			function e() {
				...
				if (t.charCodeAt(r) === Zh) {
					...
					return (n = a) >= u ? s = !0 : (e = t.charCodeAt(a++)) === Gh ? f = !0 : e === Jh && (f = !0, t.charCodeAt(a) === Gh && ++a),
			...
			s = u <= 0,
			f = !1;
			for (t.charCodeAt(u - 1) === Gh && --u, t.charCodeAt(u - 1) === Jh && --u; (r = e()) !== Wh; ) {
				for (var l = []; r !== Vh && r !== Wh; )
					l.push(r), r = e();
		...
		for (v && d.push(new lp(v, f, l, h, p)), null == e ? e = 1 / 0 : (f = t - e, l = n - e, h = t + e, p = n + e, e *= e); c = d.pop(); )
			if (!(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > p || (u = c.x1) < f || (a = c.y1) < l))
				if (v.length) {
					...
					(s = (n >= g) << 1 | t >= _) && (c = d[d.length - 1], d[d.length - 1] = d[d.length - 1 - s], d[d.length - 1 - s] = c)
				} else {
	...
	qd = {
		...
		polygonEnd: function () {
			...
			qd.lineStart = vr,
			qd.lineEnd = _r,
			zd < 0 ? (Up =  - (Op = 180), Dp =  - (Fp = 90)) : Ld > sd ? Fp = 90 : Ld < -sd && (Dp = -90),
			Xp[0] = Up,
			Xp[1] = Op
		}
	},
				...
				if (!((n = t.length - 1) <= 0)) {
					...
					if (Qd(r, u)) {
						for (i.lineStart(), o = 0; o < n; ++o)
							...
							a.push(e = new Ir(r, t, null, !0)), c.push(e.o = new Ir(r, null, e, !1)), a.push(e = new Ir(u, t, null, !1)), c.push(e.o = new Ir(u, null, e, !0))
					}
				}), a.length) {
				for (c.sort(n), Yr(a), Yr(c), o = 0, u = c.length; o < u; ++o)
					c[o].e = e = !e;
				for (var s, f, l = a[0]; ; ) {
					for (var h = l, p = !0; h.v; )
						if ((h = h.n) === l)
		...
		return function (i) {
			...
			function l() {
				...
				if (d.pop(), h.push(d), d = null, a)
					if (1 & o) {
						...
						a > 1 && 2 & o && u.push(u.pop().concat(u.shift())), p.push(u.filter(Br))
			}
			var h,
			p,
			d,
			...
			m = {
				...
				polygonEnd: function () {
					...
					p = Ps(p);
					var t = nv(h, r);
					p.length ? (y || (i.polygonStart(), y = !0), Kd(p, jr, t, e, i)) : t && (y || (i.polygonStart(), y = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()),
					y && (i.polygonEnd(), y = !1),
					p = h = null
				},
				sphere: function () {
	...
	rv = ev(function () {
			...
			return {
				...
				point: function (o, u) {
					var a = o > 0 ? fd : -fd,
					c = _d(o - e);
					_d(c - fd) < sd ? (t.point(e, r = (r + u) / 2 > 0 ? ld : -ld), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), t.point(o, r), n = 0) : i !== a && c >= fd && (_d(e - i) < sd && (e -= i * sd), _d(o - a) < sd && (o -= a * sd), r = Hr(e, r, o, u), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(a, r), n = 0),
					t.point(e = o, r = u),
					i = a
				},
				lineEnd: function () {
			...
			var i;
			if (null == t)
				i = e * ld, r.point(-fd, i), r.point(0, i), r.point(fd, i), r.point(fd, 0), r.point(fd, -i), r.point(0, -i), r.point(-fd, -i), r.point(-fd, 0), r.point(-fd, i);
		...
		return ev(n, function (t) {
			...
			return {
				...
				point: function (l, h) {
					...
					if (!i && (s = c = v) && t.lineStart(), v !== c && (!(p = e(i, d)) || Qd(i, p) || Qd(d, p)) && (d[0] += sd, d[1] += sd, v = n(d[0], d[1])), v !== c)
	...
	Jv = function (t) {
		for (var n, e, r = 0, i = (t = so(Gv.call(t))).length, o = []; r < i; )
			n = t[r], e && ho(e, n) ? ++r : (e = vo(o = fo(o, n)), r = 0);
		return e
	},
	Qv = function (t) {
		return function () {
	...
	a_ = function t(n) {
		function e(t, e, r, i, o) {
			if ((u = t._squarify) && u.ratio === n)
				...
				t._squarify = u = Yo(n, t, e, r, i, o), u.ratio = n
		}
		return e.ratio = function (n) {
			return t((n = +n) > 1 ? n : 1)
		},
		...
		lineEnd: function () {
			...
			if (e)
				if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e)
					...
					for (var r = xc(t), i = xc(n), o = 0, u = 1; u < e; ++o, ++u)
	...
	kc.prototype = {
		...
		insert: function (t, n) {
			...
			if (t) {
				...
				this._ ? (t = Cc(this._), n.P = null, n.N = t, t.P = t.L = n, e = t) : (n.P = n.N = null, this._ = n, e = null);
			for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
				e === (r = e.U).L ? (i = r.R) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.R && (Ec(this, e), e = (t = e).U), e.C = !1, r.C = !0, Ac(this, r)) : (i = r.L) && i.C ? (e.C = i.C = !1, r.C = !0, t = r) : (t === e.L && (Ac(this, e), e = (t = e).U), e.C = !1, r.C = !0, Ec(this, r)), e = t.U;
			this._.C = !1
		},
		remove: function (t) {
			t.N && (t.N.P = t.P),
					...
					do {
						...
						if (t === i.L) {
							if ((n = i.R).C && (n.C = !1, i.C = !0, Ec(this, i), n = i.R), n.L && n.L.C || n.R && n.R.C) {
								n.R && n.R.C || (n.L.C = !1, n.C = !0, Ac(this, n), n = i.R),
								n.C = i.C,
								i.C = n.R.C = !1,
								Ec(this, i),
								t = this._;
							...
							n.L && n.L.C || (n.R.C = !1, n.C = !0, Ec(this, n), n = i.L),
							n.C = i.C,
							i.C = n.L.C = !1,
							Ac(this, i),
							t = this._;
			...
			return this.cells.forEach(function (e, r) {
				if (o = (i = e.halfedges).length)
					for (var i, o, u, a = e.site, c = -1, s = n[i[o - 1]], f = s.left === a ? s.right : s.left; ++c < o; )
						u = f, f = (s = n[i[c]]).left === a ? s.right : s.left, u && f && r < u.index && r < f.index && Kc(a, u, f) < 0 && t.push([a.data, u.data, f.data])
			}),
			t
		},
		links: function () {
	...
	t.ribbon = function () {
		function t() {
			...
			_ = i.apply(this, a) - Oh,
			g = o.apply(this, a) - Oh;
			if (u || (u = t = ve()), u.moveTo(p, d), u.arc(0, 0, f, l, h), l === _ && h === g || (u.quadraticCurveTo(0, 0, v * qh(_), v * Uh(_)), u.arc(0, 0, v, _, g)), u.quadraticCurveTo(0, 0, p, d), u.closePath(), t)
	...
	t.drag = function () {
		...
		function o() {
			if (d.apply(this, arguments)) {
				...
				o = r.length;
				for (n = 0; n < o; ++n)
					(e = c(r[n].identifier, i, lf, this, arguments)) && (vt(), e("start"))
			}
		}
		function u() {
			var n,
	...
	t.forceCollide = function (t) {
		function n() {
			for (var t, n, r, c, s, f, l, h = i.length, p = 0; p < a; ++p)
				for (n = qe(i, Oe, Fe).visitAfter(e), t = 0; t < h; ++t)
		...
		function n(n) {
			for (var e = 0, r = t.length; e < p; ++e)
				for (var i, a, c, f, l, h, d, v = 0; v < r; ++v)
					a = (i = t[v]).source, f = (c = i.target).x + c.vx - a.x - a.vx || fp(), l = c.y + c.vy - a.y - a.vy || fp(), f *= h = ((h = Math.sqrt(f * f + l * l)) - u[v]) / h * n * o[v], l *= h, c.vx -= f * (d = s[v]), c.vy -= l * d, a.vx += f * (d = 1 - d), a.vy += l * d
		}
		function e() {
			if (a) {
				var n,
				...
				for (n = 0, c = new Array(l); n < h; ++n)
					(e = t[n]).index = n, "object" != typeof e.source && (e.source = Ye(p, e.source)), "object" != typeof e.target && (e.target = Ye(p, e.target)), c[e.source.index] = (c[e.source.index] || 0) + 1, c[e.target.index] = (c[e.target.index] || 0) + 1;
	...
	t.forceManyBody = function () {
		...
		function r(t, n, e, r) {
			...
			p = i * i + c * c;
			if (h * h / l < p)
				return p < f && (0 === i && (i = fp(), p += i * i), 0 === c && (c = fp(), p += c * c), p < s && (p = Math.sqrt(s * p)), o.vx += i * t.value * u / p, o.vy += c * t.value * u / p), !0;
			if (!(t.length || p >= f)) {
	...
	t.geoBounds = function (t) {
		...
		if (Fp = Op =  - (Up = Dp = 1 / 0), Hp = [], Cd(t, qd), e = Hp.length) {
			for (Hp.sort(br), n = 1, o = [r = Hp[0]]; n < e; ++n)
				wr(r, (i = Hp[n])[0]) || wr(r, i[1]) ? (xr(r[0], i[1]) > xr(r[0], r[1]) && (r[1] = i[1]), xr(i[0], r[1]) > xr(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
			for (u = -1 / 0, n = 0, r = o[e = o.length - 1]; n <= e; r = i, ++n)
				i = o[n], (a = xr(r[1], i[0])) > u && (u = a, Up = i[0], Op = r[1])
		}
		return Hp = Xp = null,
	...
	t.geoPath = function (t, n) {
		function e(t) {
			return t && ("function" == typeof o && i.pointRadius(+o.apply(this, arguments)), Cd(t, r(i))),
			i.result()
		}
		var r,
		i,
	...
	t.geoIdentity = function () {
		...
		return u = {
			...
			clipExtent: function (i) {
				return arguments.length ? (d = null == i ? (p = n = e = r = null, _v) : Xr(p = +i[0][0], n = +i[0][1], e = +i[1][0], r = +i[1][1]), t()) : null == p ? null : [[p, n], [e, r]]
			},
			scale: function (n) {
	...
	t.stratify = function () {
		function t(t) {
			...
			h = {};
			for (i = 0; i < f; ++i)
				r = t[i], a = l[i] = new co(r), null != (c = n(r, i, t)) && (c += "") && (h[s = n_ + (a.id = c)] = s in h ? r_ : a);
			for (i = 0; i < f; ++i)
			...
			if (o.parent = e_, o.eachBefore(function (t) {
					...
					--f
				}).eachBefore(ao), o.parent = null, f > 0)
	...
	t.tree = function () {
		...
		function r(t, n, e) {
			if (n) {
				for (var r, i = t, u = t, a = n, c = i.parent.children[0], s = i.m, f = u.m, l = a.m, h = c.m; a = qo(a), i = Lo(i), a && i; )
					c = Lo(c), (u = qo(u)).a = t, (r = a.z + l - i.z - s + o(a._, i._)) > 0 && (Uo(Oo(a, t, e), t, r), s += r, f += r), l += a.m, s += i.m, h += c.m, f += u.m;
				a && !qo(u) && (u.t = a, u.m += l - f),
				i && !Lo(c) && (c.t = i, c.m += s - h, e = t)
			}
			return e
		}
		function i(t) {
	...
	t.arc = function () {
		function t() {
			...
			if (c || (c = t = ve()), l < f && (s = l, l = f, f = s), l > my)
				if (d > wy - my)
					c.moveTo(l * dy(h), l * gy(h)), c.arc(0, 0, l, h, p, !v), f > my && (c.moveTo(f * dy(p), f * gy(p)), c.arc(0, 0, f, p, h, v));
				else {
					var _,
					g,
					y = h,
					...
					if (N > my) {
						var A = Pa(N / f * gy(T)),
						C = Pa(N / l * gy(T));
						(w -= 2 * A) > my ? (A *= v ? 1 : -1, x += A, b -= A) : (w = 0, x = b = (h + p) / 2),
						(M -= 2 * C) > my ? (C *= v ? 1 : -1, y += C, m -= C) : (M = 0, y = m = (h + p) / 2)
					}
					var z = l * dy(y),
					P = l * gy(y),
					R = f * dy(b),
					...
					M > my ? E > my ? (_ = Fa(D, O, z, P, l, E, v), g = Fa(q, U, R, L, l, E, v), c.moveTo(_.cx + _.x01, _.cy + _.y01), E < k ? c.arc(_.cx, _.cy, E, py(_.y01, _.x01), py(g.y01, g.x01), !v) : (c.arc(_.cx, _.cy, E, py(_.y01, _.x01), py(_.y11, _.x11), !v), c.arc(0, 0, l, py(_.cy + _.y11, _.cx + _.x11), py(g.cy + g.y11, g.cx + g.x11), !v), c.arc(g.cx, g.cy, E, py(g.y11, g.x11), py(g.y01, g.x01), !v))) : (c.moveTo(z, P), c.arc(0, 0, l, y, m, !v)) : c.moveTo(z, P),
					f > my && w > my ? S > my ? (_ = Fa(R, L, q, U, f, -S, v), g = Fa(z, P, D, O, f, -S, v), c.lineTo(_.cx + _.x01, _.cy + _.y01), S < k ? c.arc(_.cx, _.cy, S, py(_.y01, _.x01), py(g.y01, g.x01), !v) : (c.arc(_.cx, _.cy, S, py(_.y01, _.x01), py(_.y11, _.x11), !v), c.arc(0, 0, f, py(_.cy + _.y11, _.cx + _.x11), py(g.cy + g.y11, g.cx + g.x11), v), c.arc(g.cx, g.cy, S, py(g.y11, g.x11), py(g.y01, g.x01), !v))) : c.arc(0, 0, f, b, x, v) : c.lineTo(R, L)
				}
			else
				c.moveTo(0, 0);
			if (c.closePath(), t)
	...
	t.symbol = function () {
		function t() {
			var t;
			if (r || (r = t = ve()), n.apply(this, arguments).draw(r, +e.apply(this, arguments)), t)
	...
	t.zoom = function () {
		...
		function s() {
			if (y.apply(this, arguments)) {
				...
				u = nf(this);
				if (t.wheel)
					t.mouse[0][0] === u[0] && t.mouse[0][1] === u[1] || (t.mouse[1] = n.invert(t.mouse[0] = u)), clearTimeout(t.wheel);
				else {
					if (n.k === o)
						return;
		...
		function p() {
			if (y.apply(this, arguments)) {
				...
				c = u.length;
				for (os(), e = 0; e < c; ++e)
					r = u[e], i = [i = lf(this, u, r.identifier), this.__zoom.invert(i), r.identifier], o.touch0 ? o.touch1 || (o.touch1 = i) : (o.touch0 = i, n = !0);
				if (_ && (_ = clearTimeout(_), !o.touch1))
					return o.end(), void((i = ff(this).on("dblclick.zoom")) && i.apply(this, arguments));
		...
		function d() {
			...
			l = f.length;
			for (xm(), _ && (_ = clearTimeout(_)), n = 0; n < l; ++n)
				o = f[n], u = lf(this, f, o.identifier), s.touch0 && s.touch0[2] === o.identifier ? s.touch0[0] = u : s.touch1 && s.touch1[2] === o.identifier && (s.touch1[0] = u);
		...
		c.prototype = {
			start: function () {
				return 1 == ++this.active && (this.index = z.push(this) - 1, this.emit("start")),
				this
			},
			zoom: function (t, n) {
				...
				return 0 == --this.active && (z.splice(this.index, 1), this.index = -1, this.emit("end")),
				this
			},
			emit: function (t) {
		...
		n.extent = function (t) {
			return arguments.length ? (m = "function" == typeof t ? t : ym([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), n) : m
		},
		n.scaleExtent = function (t) {
			return arguments.length ? (w = +t[0], M = +t[1], n) : [w, M]
		},
		n.translateExtent = function (t) {
			return arguments.length ? (T = +t[0][0], N = +t[1][0], S = +t[0][1], E = +t[1][1], n) : [[T, S], [N, E]]
		},
