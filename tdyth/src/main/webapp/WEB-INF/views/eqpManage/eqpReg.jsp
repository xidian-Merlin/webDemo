...
<div class="p-panel um-panel right-panel" id="right-panel" style="left:230px">
	<div class="um-panel-head">
		<div class="table-div-outer"  style="padding:0 10px ">
			...
			<a href="javascript:void(0);" id="autoAdd" class="bgblue"  style="right:30px;" >
					<i class="btn-commen add-btn"></i>
					<span>自动扫描</span>
				</a>
			<a href="javascript:void(0);" id="batch_add_btn" class="bgblue"  style="right:20px;">
					<i class="btn-commen add-btn"></i>
					<span>批量新增</span>
				</a>
				<a href="javascript:void(0);" id="add_btn" class="bgblue" style="right:10px;">
					<i class="btn-commen add-btn"></i>
					<span>新增</span>
				</a>
...
<script src="/tdyth/resources/js/eqpManager/eqpRegist.js"></script>
</body>